...
public class BoogeyMonster extends Monster {
		private String monsterType;
		private String specialAttk;
		
		
		public BoogeyMonster() {
			super();
			
		}

		public BoogeyMonster(String name, int totalLvl, int attk, int hpLvl, String monsterType, String specialAttk) {
